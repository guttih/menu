...
void TerminalOutput::printHelp( const char *appName )
{
    ...
    println( "Usage: ", str.c_str(), " [-d_title  <d_titleT>...] [OPTIONS]... (-lines <line>...)" );
    ...
    println( " -descriptions  Description for selected line.  This option must be followed by descriptions argument(s)." );
    println( " -d_title       Title shown above description.  This option must be followed by d_titleT argument." );
    println( " -d_title_x     Set the horizontal offset of the description title this option must be follwed by a number." );
    ...
    println( " line          Each selectable item displayed in the menu.  Best to have this a double quoted text." );
    println( " titleLine     Text displayed above the menu.  Double quote and align by using spaces within the quotes." );
    ...
    println( " d_titleT      Title shown above a line description." );
