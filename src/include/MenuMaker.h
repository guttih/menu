...
public:
    ...
    {
        return itemIndex < 0 || itemIndex > ( ( int ) _menuItems.size() ) - 1 ? "" : _menuItems[ itemIndex ];
    }
    ...
    void setAlignment( HORIZONTAL_ALIGNMENT align )
    {
        _align = align;
    }
    ...
    void setDescriptionTitleOffsetX( int offsetX )
    {
        _descriptionTitleoffsetX = offsetX;
    };
};
